            ...
            <div className='md:flex justify-around'>
                ...
                <div className='ml-10'>
                    ...
                    <div className='flex justify-between mt-20'>
                        <div className='shadow-xl p-3 bg-slate-100 rounded-lg'>
                            <h1 className='text-5xl font-extrabold text-yellow-500'>12K+</h1>
                            <p className='text-xl text-slate-500'>success <br /> journey</p>
                        </div>

                        <div className='shadow-xl p-3 bg-slate-100 rounded-lg'>
                            <h1 className='text-5xl font-extrabold text-yellow-500'>16K+</h1>
                            <p className='text-xl text-slate-500'>Award <br /> wining</p>
                        </div>

                        <div className='shadow-xl p-3 bg-slate-100 rounded-lg'>
                            <h1 className='text-5xl font-extrabold text-yellow-500'>20K+</h1>
                            <p className='text-xl text-slate-500'>Year of <br /> experience</p>
                        </div>
